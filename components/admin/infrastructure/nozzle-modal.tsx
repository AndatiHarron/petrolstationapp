                    ...
                    <View className="bg-slate-900 rounded-t-3xl border-t border-slate-700 max-h-[90%]">
                        ...
                        <ScrollView className="px-6 pt-6" contentContainerStyle={{ paddingBottom: 20 }}>
                            ...
                            <Pressable
                                ...
                                className={`bg-slate-800 p-4 rounded-xl border border-slate-700 mb-2 flex-row justify-between items-center ${!stationId ? 'opacity-60' : ''}`}
                            >
                                <Text className={selectedTank ? 'text-white' : 'text-slate-500'}>
                                    ...
                                    <ScrollView nestedScrollEnabled>
                                        {tanksForStation.map((t) => (
                                            <Pressable
                                                ...
                                                className={`p-3 border-b border-slate-700 ${tankId === t.id ? 'bg-blue-600/20' : ''
                                                    }`}
                                            >
                                                <Text className={tankId === t.id ? 'text-blue-400' : 'text-white'}>
                                                    {t.name}
                                        ...
                                        {tanksForStation.length === 0 ? (
                                            <View className="p-3">
                                                <Text className="text-slate-500 text-sm">No tanks at this station</Text>
                                            </View>
                                        ) : null}
                                    </ScrollView>
                                </View>
