            ...
            <SafeAreaView className="flex-1">
                ...
                >
                    <View className="mb-6 mt-4">
                        ...
                        <Text className="text-slate-500 text-sm mt-1">System settings and configuration</Text>
                    </View>
                    ...
                    <View className="bg-slate-800 border border-slate-700/50 rounded-xl p-8 items-center justify-center">
                        ...
                        <Text className="text-slate-500 text-sm mt-2">User management, roles, and settings</Text>
                    </View>
                </ScrollView>
            </SafeAreaView>
        </View>
